...
from dqn_agent_with_greedy import DQNAgent
import torch
        ...
        if episode == 0:
            ...
            if not force_change:
                if self.check_curriculum_advancement(episode, episode_score):
                    ...
                    self.agent.writer.add_scalar('Agent/Epsilon_Reset', self.agent.epsilon, self.total_steps)
        ...
        try:
            for episode in range(episodes):
                ...
                if episode_score > self.best_score:
                    ...
                    self.save_model(f"best_model_score_improved_{episode_score}.pth")
