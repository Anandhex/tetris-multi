...
class ExtendedPowerupTrainer:
    ...
    def load_or_generate_dataset(self, dataset_path=None, num_games=8000, force_regenerate=False):
        ...
        # Initialize buffer
        try:
            from python.powerup.enhanced_game_state_generator import EnhancedGameStateBuffer, RealisticTetrisGameGenerator
...
def create_comprehensive_dataset():
    ...
    try:
        from python.powerup.enhanced_game_state_generator import RealisticTetrisGameGenerator, EnhancedGameStateBuffer
